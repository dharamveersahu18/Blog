...
export default function PostForm({ post }) {
    ...
    const submit = async (data) => {
        ...
        if (!userData) {
            alert("Submission blocked: You do not seem to be logged in. Your session might have expired or disconnected. Please refresh and log in again.");
        ...
        if (!userId) {
            alert("Submission blocked: Could not locate your User ID profile token. Try logging out and back in.");
        ...
        try {
            ...
            alert("A network error occurred while reaching Appwrite Cloud. Please check your internet connection stability and try again.");
        }
    };
